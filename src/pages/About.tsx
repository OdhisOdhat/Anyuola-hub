            ...
            <div className="relative aspect-[4/3] overflow-hidden bg-zinc-100 flex items-center justify-center">
              ...
              {isAdmin && (
                <button
                  ...
                  className="absolute top-4 right-4 z-20 px-3.5 py-1.5 rounded-xl bg-zinc-950/80 hover:bg-zinc-950 text-emerald-300 border border-emerald-500/40 text-[10px] font-black uppercase tracking-wider backdrop-blur-md transition-all shadow-md flex items-center gap-1.5 cursor-pointer"
                >
                  <Upload className="w-3 h-3 text-emerald-400" />
                  Admin: Change Photo
                </button>
